    ...
    <>
      ...
      <div className={cn("flex relative", className)}>
        <div className="flex relative overflow-hidden flex-row gap-1 items-center w-min h-min">
          {prefix && (
            <div className="whitespace-pre size-auto relative">{prefix}</div>
          )}
          <div
            className="opacity-100 relative w-auto overflow-hidden"
            style={{
              height: `${height}px`,
              WebkitMaskImage:
                "linear-gradient(rgba(0,0,0,0) 0%, rgb(0,0,0) 43.6902%, rgba(0,0,0,0) 100%)",
              maskImage:
                "linear-gradient(rgba(0,0,0,0) 0%, rgb(0,0,0) 43.6902%, rgba(0,0,0,0) 100%)",
            }}
          >
            ...
            >
              {React.Children.map(children, (child, index) => (
                <div
                  key={index}
                  className="h-[40px] flex items-center whitespace-nowrap"
                  style={
                    {
                      "--index": index,
